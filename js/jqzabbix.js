...
function createAjaxOption(method, params, success, error, complete,isAsync=true){
...
this.sendAjaxRequest = function(method, params, success, error, complete, isAsync=true) {
    return $.ajax(createAjaxOption(method, params, success, error, complete, isAsync=true));
}
...
this.userLogin = function(params, success, error, complete) {
    ...
    return this.sendAjaxRequest(method, params, successMethod, error, complete, false);
}
